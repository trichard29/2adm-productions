...
<html class="no-js" lang="fr">
    ...
    <body <?php body_class(); ?>>
            ...
            <header>
            <!-- start navigation -->
            <nav class="navbar navbar-default bootsnav navbar-fixed-top header-light background-white nav-box-width navbar-expand-lg menu-center border-white-light border-bottom">
